...
do l = lmin, lmax
  ...
  vlft(l) = 1.0d0/vlft(l)
  vrgh(l) = 1.0d0/vrgh(l)
  plfti(l)= 1.0d0/plft(l)
  prghi(l)= 1.0d0/prgh(l)
...
do l = lmin, lmax
  do n = 1, 12
    pmold(l) = pmid(l)
    wlft (l) = 1.0d0 + gamfac1*(pmid(l) - plft(l)) * plfti(l)   
    wrgh (l) = 1.0d0 + gamfac1*(pmid(l) - prgh(l)) * prghi(l)
